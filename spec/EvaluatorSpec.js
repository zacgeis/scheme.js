describe("Evaluator", function() {
  ...
  it("should evaluate simple expressions", function() {
    ...
    expect(result).toEqual(new SicpValue('number', 2));
  });
  it("should evaluate nested expressions", function() {
    var str = '(+ (+ 2 3) (+ 1 4))';
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('number', 10));
  });
  ...
  it("should evaluate defined expressions", function() {
    ...
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('number', 5));
  });
  ...
  it("should allow for truthy expressions", function() {
    var str = '(> 1 0)';
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('boolean', true));
  });
  it("should allow for truthy expressions", function() {
    var str = '(< 1 0)';
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('boolean', false));
  });
  it("should allow for truthy expressions", function() {
    var str = '(= 1 1)';
    var result = evaluator.input(str);
  ...
  it("should handle dot expressions", function() {
    ...
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('list', [new SicpValue('number', 1), new SicpValue('number', 2), new SicpValue('number', 3)]));
  });
  it("should allow for recursive expressions", function() {
    var str = '(define (factorial n) (if (= n 0) 1 (* n (factorial (- n 1))))) (factorial 5)';
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('number', 120));
  });
  ...
  it("should allow for expression results", function() {
    ...
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('string', 'an example string'));
  });
  it("should support lambdas", function() {
    var str = '(define test (lambda (a b) (+ a b))) (test 1 2)';
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('number', 3));
  });
  ...
  it("should support cons", function() {
    var str = '(cons 1 2)';
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('list', [new SicpValue('number', 1), new SicpValue('number', 2)]));
  });
  it("should support car", function() {
    var str = '(cdr (cons 1 2))';
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('list', [new SicpValue('number', 2)]));
  });
  it("should support cdr", function() {
    var str = '(car (cons 1 2))';
    var result = evaluator.input(str);
    expect(result).toEqual(new SicpValue('number', 1));
  });
});
